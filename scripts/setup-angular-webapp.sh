...
readonly LOG_FILE="${root_folder}/deploy-angular-webapp.log"
...
function setup() {
  ...
  readonly TEMPLATE_CONFIG_FILE="${root_folder}/../angular/src/assets/template.config.json"
  ...
  sed -i "s#xxx-protectedUrl-xxx#${API_PROTECTED}#" ${CONFIG_FILE}
